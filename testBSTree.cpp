...
int main() {
  ...
  try {
    bstree.search(0);
    std::cout << "bstree.search(0) => ERROR! It did not throw "
                 "std::runtime_error... :("
              << std::endl;
  } catch (std::runtime_error &e) {
    std::cout << "bstree.search(0) => OK! It throwed std::runtime_error: "
              << e.what() << std::endl;
  }
  ...
  try {
    bstree.insert(9);
    std::cout << "bstree.insert(9) => ERROR! It did not throw "
                 "std::runtime_error... :("
              << std::endl;
  } catch (std::runtime_error &e) {
    std::cout << "bstree.insert(9) => OK! It throwed std::runtime_error: "
              << e.what() << std::endl;
  }

  try {
    bstree.remove(50);
    std::cout << "bstree.remove(50) => ERROR! It did not throw "
                 "std::runtime_error... :("
              << std::endl;
  } catch (std::runtime_error &e) {
    std::cout << "bstree.remove(50) => OK! It throwed std::runtime_error: "
              << e.what() << std::endl;
  }
